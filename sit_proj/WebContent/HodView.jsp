...
<body class="gradientbody">
	<div class="resultdiv">
		...
		<h4>
			<span style="color: Blue; padding-left: 1cm;"><a
				href="openStudentAddView.do"
				title="Click here to Add new Student to Cloud">Add Student</a></span>
		</h4>
		<h4>
			<span style="color: Blue; padding-left: 1cm;"><a
				href="openStudentDeleteView.do"
				title="Click here to Delete Existing Student from Cloud">Delete
					Student</a></span>
		</h4>
		<h4>
			<span style="color: Blue; padding-left: 1cm;"><a
				href="openStudentUploadView.do" title="Click here to Marks to Cloud">Upload
					Marks</a></span>
		</h4>
		<br /> <br /> <br />
		<%
		...
		<%
			if (request.getAttribute("uploadsuccess") != null) {
				out.println("<h4>Success . . . ! !</h4>"
						+ request.getAttribute("uplooadsuccess"));
			}
		%>
	</div>
</body>
